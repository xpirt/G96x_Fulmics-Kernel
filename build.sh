...
KERNEL_VERSION="1.0"
KERNEL_NAME="-Fulmics-Kernel"
export LOCALVERSION=${KERNEL_NAME}-${KERNEL_VERSION}

case $MODEL in
starlte)
	case $VARIANT in
	can|duos|eur|xx)
		KERNEL_DEFCONFIG=xpirt_starlte_defconfig
		;;
	*)
...
star2lte)
	case $VARIANT in
	can|duos|eur|xx)
		KERNEL_DEFCONFIG=xpirt_star2lte_defconfig
		;;
	*)
		echo "Unknown variant: $VARIANT"
		exit 1
